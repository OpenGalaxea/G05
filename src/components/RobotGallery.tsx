...
// Out-of-box household deployments. Clips live in public/videos/oob/.
const DEMOS = [
  ...
  return (
    <section className="w-full">
      ...
      <p className="text-lg md:text-xl text-neutral-300 font-light leading-[1.8] mb-12">
        The unified action space lets a single set of weights deploy across distinct robot morphologies without changing the network. Combined with strong zero-shot instruction following, this turns G0.5 into a general-purpose household manipulator straight out of the box.
      </p>
      ...
      <p className="text-lg md:text-xl text-neutral-300 font-light leading-[1.8] mb-10">
        From the kitchen to the workbench, G0.5 follows everyday instructions across real homes — operating appliances, preparing food, and tidying clutter. Hover any clip to play it.
      </p>
